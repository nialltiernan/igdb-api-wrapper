...
class ApiClientTest extends Base
{
    ...
    public function resources()
    {
        ...
        $this->assertInstanceOf(GameEngineResource::class, $this->client->gameEngine());
        $this->assertInstanceOf(GameModeResource::class, $this->client->gameMode());
        $this->assertInstanceOf(GameResource::class, $this->client->game());
        ...
        $this->assertInstanceOf(GameVersionResource::class, $this->client->gameVersion());
        ...
        $this->assertInstanceOf(PlatformFamilyResource::class, $this->client->platformFamily());
        ...
        $this->assertInstanceOf(PlatformVersionReleaseDateResource::class, $this->client->platformVersionReleaseDate());
        $this->assertInstanceOf(PlatformVersionResource::class, $this->client->platformVersion());
        $this->assertInstanceOf(PlatformWebsiteResource::class, $this->client->platformWebsite());
        $this->assertInstanceOf(PlayerPerspectiveResource::class, $this->client->playerPerspective());
        $this->assertInstanceOf(ReleaseDateResource::class, $this->client->releaseDate());
